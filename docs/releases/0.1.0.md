...
Snapshot before 0.5 development. All commands in this document require the unchanged 0.1.0 release. Later verification is recorded in the root STATUS.md.
